    ...
    <div className="d-flex flex-column vh-100">
      ...
      <header>
        <Navbar
          ...
          style={{ backgroundColor: mode === 'light' ? '#008080' : '#6c757d' }}
          variant="dark"
          expand="lg"
        >
              ...
              <Nav className="justify-content-end">
                ...
                {userInfo ? (
                  <NavDropdown
                    ...
                    title={<span className="text-white">{`Hello, ${userInfo.name}`}</span>}
                  >
                  ...
                  <NavDropdown className="header-link" title={<span className="text-white">Hello, sign in</span>}>
                    <LinkContainer to="/signin">
                      <NavDropdown.Item>Sign In</NavDropdown.Item>
                    </LinkContainer>
                  </NavDropdown>
                )}
                <Link to="/orderhistory" className="nav-link header-link text-white">
                  Orders
                </Link>
                <Link to="/cart" className="nav-link header-link p-0 text-white">
          ...
          <div className="sub-header">
            <div className="d-flex">
              <Link
                to="#"
                className="nav-link header-link p-1 text-white"
              ...
              {['Todays Deal', 'Gifts', 'On Sale'].map((x) => (
                <Link
                  key={x}
                  className="nav-link header-link p-1 px-3 text-white"
                  to={`/search?tag=${x}`}
                >
                  {x}
                </Link>
